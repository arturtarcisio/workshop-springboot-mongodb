package com.arturtarcisio.workshopmongo.config;

import com.arturtarcisio.workshopmongo.domain.Post;
import com.arturtarcisio.workshopmongo.domain.User;
import com.arturtarcisio.workshopmongo.dto.AuthorDTO;
import com.arturtarcisio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem",
                "Vou viajar para São Paulo! Abraço!", new AuthorDTO(maria));
